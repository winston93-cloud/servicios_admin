-- =============================================================================
-- pago_interno_old — archivo de pagos internos legacy (fuera del talón actual)
--
-- Misma estructura que public.pago_interno.
-- Ejecutar UNA vez en InsForge (Winston Servicios) antes de archivar filas.
-- =============================================================================
...
COMMENT ON TABLE public.pago_interno_old IS
  'Archivo de pago_interno legacy (folios ≥4000, talón 26550+, 3480–3999, y 3200–3479 pre-2026).';
