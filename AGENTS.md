...
- **Módulo `/servicios`:** claro con **UI UX PRO MAX** (navy + slate); oscuro con **Totality Festival** (`servicios-original-theme.css` + `servicios-totality-alumno.css`). Mismo `ThemeToggle`.
