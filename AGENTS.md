...
- **Módulo `/servicios`:** excluido de Totality — **UI UX PRO MAX** (`servicios/servicios-original-theme.css`): claro (navy + slate) y oscuro (slate profundo + azul) vía el mismo `ThemeToggle`.
