...
import { guardarCaptura, obtenerCaptura } from '@/lib/boletasKinderEnService'
...
export async function PUT(req: Request) {
  try {
    ...
    const body = (await req.json()) as {
      ...
      behavioral?: Record<number | string, string>
      maternal?: Record<number | string, string>
    ...
    const result = await guardarCaptura({
      ...
      behavioral: toNumMap(body.behavioral),
      maternal: toNumMap(body.maternal),
