...
const POR_CODIGO: Record<number, PlantillaError> = {
  ...
  446: {
    titulo: 'Verificación no completada',
    mensaje: 'El proceso 3D Secure no pudo completarse con su banco.',
    sugerencia: 'Intente de nuevo o use otra tarjeta.',
    categoria: 'banco',
  },
  447: {
    titulo: 'No se pudo iniciar la verificación',
    mensaje: 'Banorte no pudo procesar la solicitud de verificación 3D Secure.',
