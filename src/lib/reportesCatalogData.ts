...
export const REPORTE_CATEGORIAS: ReporteCategoria[] = [
  ...
  { id: 'curp', titulo: 'CURP', orden: 3 },
  { id: 'listas', titulo: 'Listas de alumnos', orden: 4 },
  {
  ...
  { id: 'reinscritos', titulo: 'Reinscritos', subtitulo: '1 pago y 2 pagos', orden: 7 },
  { id: 'becados', titulo: 'Becados Winston', orden: 8 },
...
export const REPORTE_ENTRADAS: ReporteCatalogEntry[] = [
  ...
  },
  {
    ...
    descripcion: 'Deudores desde 1 pago (IWC · Primaria/Secundaria).',
    accent: 'amber',
    motor: 'api-next',
    usaCiclo: 'escolar',
    keywords: ['deudores', 'iwch', 'winston', '1 mes'],
  },
  {
    id: 'deudores-iew-1mes',
    categoriaId: 'deudores',
    titulo: 'Deudores 1 mes — Educativo',
    descripcion: 'Deudores desde 1 pago (IEW · Maternal/Kinder).',
    accent: 'amber',
    motor: 'api-next',
    usaCiclo: 'escolar',
    keywords: ['deudores', 'iew', 'educativo', '1 mes'],
  },
  {
    id: 'suspendidos-iwc',
    categoriaId: 'deudores',
    titulo: 'Suspendidos — Winston',
    descripcion: 'Deudores con 2 o más adeudos (IWC · Primaria/Secundaria).',
    accent: 'rose',
    motor: 'api-next',
    usaCiclo: 'escolar',
    keywords: ['suspendidos', 'iwc', 'winston', 'deudores'],
  },
  {
    id: 'suspendidos-iew',
    categoriaId: 'deudores',
    titulo: 'Suspendidos — Educativo',
    descripcion: 'Deudores con 2 o más adeudos (IEW · Maternal/Kinder).',
    accent: 'rose',
    motor: 'api-next',
    usaCiclo: 'escolar',
    keywords: ['suspendidos', 'iew', 'educativo', 'deudores'],
  },
  {
    id: 'inscripciones',
    categoriaId: 'otros',
