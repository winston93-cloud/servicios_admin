...
const MAP_EDUCATIVO: Record<string, CfdiConceptoResuelto> = {
  ...
  '30': { descripcion: 'Pago Anual', codigoProducto: '86121500' },
  '31': { descripcion: 'Pago Colegiaturas', codigoProducto: '86121500' },
...
const MAP_CHURCHILL: Record<string, CfdiConceptoResuelto> = {
  ...
  '30': { descripcion: 'Pago Anual', codigoProducto: '86121503' },
  '31': { descripcion: 'Pago Colegiaturas', codigoProducto: '86121503' },
